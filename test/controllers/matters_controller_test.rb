...
class MattersControllerTest < ActionController::TestCase
  ...
  test "should create matter" do
    assert_difference('Matter.count') do
      post :create, matter: { custo: @matter.custo, description: @matter.description, duration_id: @matter.duration_id, name: @matter.name, nbmaxstudent: @matter.nbmaxstudent, type_id: @matter.type_id }
    end
  ...
  test "should update matter" do
    patch :update, id: @matter, matter: { custo: @matter.custo, description: @matter.description, duration_id: @matter.duration_id, name: @matter.name, nbmaxstudent: @matter.nbmaxstudent, type_id: @matter.type_id }
    assert_redirected_to matter_path(assigns(:matter))
  end
