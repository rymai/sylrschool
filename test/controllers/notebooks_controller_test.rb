...
class NotebooksControllerTest < ActionController::TestCase
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post :create, notebook: { custo: @notebook.custo, description: @notebook.description, name: @notebook.name, notebooktext: @notebook.notebooktext, student_id: @notebook.student_id }
    end
  ...
  test "should update notebook" do
    patch :update, id: @notebook, notebook: { custo: @notebook.custo, description: @notebook.description, name: @notebook.name, notebooktext: @notebook.notebooktext, student_id: @notebook.student_id }
    assert_redirected_to notebook_path(assigns(:notebook))
  end
