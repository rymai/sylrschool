...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { custo: @element.custo, description: @element.description, for_what: @element.for_what, name: @element.name }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { custo: @element.custo, description: @element.description, for_what: @element.for_what, name: @element.name }
    assert_redirected_to element_path(assigns(:element))
  end
