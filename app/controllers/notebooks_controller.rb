class NotebooksController < ApplicationController
  ...
  def index
    @grid = NotebooksGrid.new(grid_params) do |scope|
      scope.page(params[:page])
    end
  end

  def grid_params
    params.fetch(:notebooks_grid, {}).permit!
  end
  ...
  def notebook_params
    params.require(:notebook).permit(:name, :notebooktext, :student_id, :description, :custo)
  end
end
